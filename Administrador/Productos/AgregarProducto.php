...
<body>
    ...
    <div class="agregarProducto">
        <form action="ControllerAgregarProducto.php" method="POST" enctype="multipart/form-data">
            <div class="input-group">
                <input class="input" required type="text" id="nombreProducto" name="nombreProducto">
