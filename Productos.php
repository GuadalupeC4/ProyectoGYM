...
<body>
    ...
    <div class="paquetes">
        <div class="row">
            ...
            <div class="column">
                <div class="contenido">
                    <img src="http://localhost/ProyectoGYM/Administrador/ImagenesProductos/<?php echo htmlspecialchars($producto['imagen']); ?>">
                    <h3 class="title"><?php echo $producto['nombreProducto']; ?></h3>
